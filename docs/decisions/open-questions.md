...
Add a row above with a short description and a link to more detail — either inline in this table (if it's brief)
or as its own page under `docs/decisions/` (if it needs worked examples or a longer write-up). Link to any
relevant GitHub issue or discussion where it's being debated.
