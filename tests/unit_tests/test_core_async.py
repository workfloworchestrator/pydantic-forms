...
# async def test_start_form():
#     async def input_form_async(state):
#         user_input = yield TestForm
#         yield {**user_input.dict(), "extra": 234}
#
#     def input_form_sync(state):
#         user_input = yield TestForm
#         return {**user_input.dict(), "extra": 345}
#
#     with mock.patch.object(pydantic_forms.core.shared, "FORMS", {}):
#         register_form(input_form_async.__name__, input_form_async)
#         register_form(input_form_sync.__name__, input_form_sync)
#         print("FOOOORMS\n", getattr(pydantic_forms.core.shared, "FORMS"), "\n")
#         validated_data2 = await start_form(input_form_sync.__name__, {}, [{"generic_select": "b"}])
#         validated_data1 = await start_form(input_form_async.__name__, {}, [{"generic_select": "a"}])
#
#     expected1 = {"generic_select": "a", "extra": 234}
#     expected2 = {"generic_select": "a", "extra": 345}
#     assert expected1 == json_loads(json_dumps(validated_data1))
#     assert expected2 == json_loads(json_dumps(validated_data2))
...
#
#
# async def test_start_form_sync():
#     def input_form_sync(state):
#         user_input = yield TestForm
#         return {**user_input.dict(), "extra": 345}
#
#     checkstuff(input_form_sync)
#
#     with mock.patch.object(pydantic_forms.core.shared, "FORMS", {}):
#         register_form(input_form_sync.__name__, input_form_sync)
#         # print("FOOOORMS\n", getattr(pydantic_forms.core.shared, "FORMS"), "\n")
...
#
#
# async def test_start_form_async():
#     async def input_form_async(state):
#         user_input = yield TestForm
#         yield {**user_input.dict(), "extra": 234}
#
#     checkstuff(input_form_async)
#
#     with mock.patch.object(pydantic_forms.core.shared, "FORMS", {}):
#         register_form(input_form_async.__name__, input_form_async)
#         # print("FOOOORMS\n", getattr(pydantic_forms.core.shared, "FORMS"), "\n")
